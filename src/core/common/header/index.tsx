...
import { Companylogo, CompnayIcon, CompanyWhiteLogo } from '../../../environment'
...
const Header = () => {
  ...
  // Wrapper structure stored in localStorage
  interface UserResponse {
    data: UserData;
    message: string;
    status: boolean;
  }
  // 2. Safely parse from localStorage
  const storedUserData = window.localStorage.getItem("userData");

  const userInfo: UserResponse | null = storedUserData
      ...
      <div className="header">
        ...
        >
          ...
          <Link to={routes.adminDashboard} className="logo-small">
            <ImageWithBasePath src={CompnayIcon} alt="Logo" />
          </Link>
                ...
                <div className="dropdown-menu">
                  <div className="d-block">
                    <div className="d-flex align-items-center p-2">
                      ...
                      <div>
                        <h6>{userInfo?.data?.firstname + ' ' + userInfo?.data?.lastname}</h6>
                        <p className="text-primary mb-0">{userInfo?.data?.roleName}</p>
                      </div>
                    </div>
                    <hr className="m-0" />
                    <Link
