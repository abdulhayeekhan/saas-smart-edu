...
import BulkImportAdmissions from "../peoples/students/upload-bulk-admission";
import StudentList from "../peoples/students/student-list";
import StudentCard from "../peoples/students/student-card/StudentCard";
import StudentInquiry from '../peoples/students/admisison-inquiry'
import AddStudentInquiry from "../peoples/students/add-inquiry";
...
import StudentFeeDiscount from "../peoples/students/student-details/feeDiscount";
...
import StudentLedger from "../peoples/students/student-details/studentLedger";
...
import ClassSection from "../acdemic-manager/class-section";
import ClassGrade from "../acdemic-manager/class-grade";
import ClassSessions from "../acdemic-manager/class-session";
import ClassSubjects from '../acdemic-manager/class-subject';
...
import EmployeeType from "../hrm/employee-type";
...
import FeeGenerate from "../fee-management-system/fee-generate";
import FeeCreationJob from "../automation/feecreationjob";
import FeeCreationJobLogs from "../automation/feecreationjoblogs";
...
import FeesTypes from "../acdemic-manager/fee-types/feesTypes";
import DiscountTypes from "../acdemic-manager/discount-type";
import FeesStructure from "../acdemic-manager/fee-structure";
...
import NotificationSettings from "../settings/systemSettings/notificationSettings";
...
import FinancialYear from "../accounts/financial-year";
import FinancialYearRollover from "../accounts/financial-year-rollover";
...
import InvoiceReceiptSummaryReport from "../report/invoice-receipt-summary-report/invoiceReceiptSummaryReport";
import StudentStrengthReport from "../report/student-strength-report/studentStrengthReport";
import AverageFeeReport from "../report/average-fee-report/averageFeeReport";
import CampusAdmissionStatusReport from "../report/campus-admission-status-report/CampusAdmissionStatusReport";
import ContactList from "../report/contact-list/ContactList";
import BranchExpenseReport from "../report/branch-expense-report/BranchExpenseReport";
...
//new
import ClassTeacher from "../hrm/attendance/class-teacher";
import CampusList from "../management/campus-management/campus-management";
import ChartOfAccount from "../accounts/chart-of-account";
...
import BulkFeeReceipt from "../fee-management-system/bulk-fee-receipt";
...
import SingleFeeVoucherPrint from "../fee-management-system/single-fee-voucher/voucher-print";
import HOOpenningBalance from "../accounts/openning-balance";
import CampusOpenningBalance from "../accounts/campus-openning-balance";
import AccountSetting from "../fee-management-system/account-setting";
import GovtNotices from "../announcements/govt-notices";
import BooksOrder from "../books-order/books-order";
import ProductDetail from "../books-order/product-detail";
const routes = all_routes;

export const publicRoutes = [
  {
    path: routes.booksOrder,
    element: <BooksOrder />,
    route: Route,
  },
  {
  ...
  {
    path: routes.campusManagement,
    element: <CampusList/>,
    route: Route,
  },
  {
    path: routes.campusBank,
    element: <CampusBank />,
    route: Route,
  },
  {
  ...
  // Peoples Module
  {
    path: routes.studentInquiry,
    element: <StudentInquiry />,
  },
  {
    path: routes.addstudentInquiry,
    element: <AddStudentInquiry/>
  },
  {
  ...
  {
    path: routes.addStudentAdmission,
    element: <AddStudent />,
  },
  {
    path: routes.addBlukAdmission,
    element: <BulkImportAdmissions />,
  },
  {
  ...
  {
    path: routes.studentFeeDiscount,
    element: <StudentFeeDiscount />,
  },
  {
  ...
  {
    path: routes.classGrade,
    element: <ClassGrade/>,
  },
  {
    path: routes.classSession,
    element: <ClassSessions/>,
  },
  {
    path: routes.classSubjects,
  ...
  {
    path: routes.employeeType,
    element: <EmployeeType />,
  },
  {
    path: routes.campusEmployee,
    element: <AppCampusEmployee />,
  },
  {
    path: routes.addCampusEmployee,
  ...
  {
    path: routes.feeGenerate,
    element: <FeeGenerate />,
  },
  {
    path: routes.feeCreationJob,
    element: <FeeCreationJob />,
  },
  {
    path: routes.feeCreationJobLogs,
    element: <FeeCreationJobLogs />,
  },
  {
    path: routes.singleFeeGenerate,
    element: <SingleFeeGenerate />,
  },
  {
    path: routes.singleFeePrint,
    element: <SingleFeeVoucherPrint />,
  },
  {
    path: routes.studentFeeGenerate,
    element: <SingleFeeGenerate />,
  },
  {
    path: routes.feeInvoices,
    element: <FeesInvoices />,
  },
  {
  ...
  {
    path: routes.discountTransactionSetting,
    element: <DiscountTransactionSetting />
  },
  {
  ...
  {
    path: routes.campusChartofaccounts,
    element: <CampusChartOfAccount />,
  },
  {
    path: routes.bpvoucher,
    element: <BankPaymentVoucher />,
  },
  {
    path: routes.brvoucher,
    element: <BankReceiptVoucher />,
  },
  {
    path: routes.cpvoucher,
    element: <CashPaymentVoucher />,
  },
  {
    path: routes.crvoucher,
    element: <CashReceiptVoucher />,
  },
  {
    path: routes.journalvoucher,
    element: <JournalVoucher />,
  },
  {
    path: routes.openningBalance,
    element: <HOOpenningBalance />,
    route: Route,
  },
  {
    path: routes.campusOpenningBalance,
    element: <CampusOpenningBalance />,
    route: Route,
  },
  {
    path: routes.ledgerReports,
    element: <LedgerReports />,
  },
  {
    path: routes.collectionReport,
    element: <CollectionReport />,
  },
  {
    path: routes.schoolFinancialAudit,
    element: <SchoolFinancialAudit />,
  },
  {
    path: routes.expense,
    element: <Expense />,
  ...
  {
    path: routes.financialYear,
    element: <FinancialYear />,
  },
  {
    path: routes.financialYearRollover,
    element: <FinancialYearRollover />,
  },
  {
    path: routes.invoice,
    element: <Invoice />,
  ...
  {
    path: routes.invoiceReceiptSummaryReport,
    element: <InvoiceReceiptSummaryReport />,
  },
  {
    path: routes.studentStrengthReport,
    element: <StudentStrengthReport />,
  },
  {
    path: routes.averageFeeReport,
    element: <AverageFeeReport />,
    id: "average_fee_report",
  },
  {
    path: routes.campusAdmissionStatusReport,
    element: <CampusAdmissionStatusReport />,
    id: "campus_admission_status_report",
  },
  {
  ...
  {
    path: routes.branchExpenseReport,
    element: <BranchExpenseReport />,
    id: "branch_expense_report",
  },
  {
